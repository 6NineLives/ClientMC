...
import com.archclient.client.ui.overlay.StringSanitizer;
...
public class InputFieldElement extends AbstractElement {
    ...
    public InputFieldElement(EaglerFontRenderer fontRenderer, String text, int n, int n2) {
    ...
    public boolean lIIIIIIIIIlIllIIllIlIIlIl(char c, int n) {
        ...
        switch (c) {
            ...
            case '': {
                ACGuiScreen.wrapped$setClipboardString(this.IlllIllIlIIIIlIIlIIllIIIl());
                return true;
            }
            case '': {
                if (this.IIIlllIIIllIllIlIIIIIIlII) {
                    this.lIIIIIIIIIlIllIIllIlIIlIl(ACGuiScreen.wrapped$getClipboardString());
                }
                return true;
            }
            case '': {
        ...
        switch (n) {
            case 14: {
                if (ACGuiScreen.wrapped$isCtrlKeyDown()) {
                    if (this.IIIlllIIIllIllIlIIIIIIlII) {
            ...
            case 199: {
                if (ACGuiScreen.wrapped$isShiftKeyDown()) {
                    this.lIIIIllIIlIlIllIIIlIllIlI(0);
                } else {
            ...
            case 203: {
                ...
                } else if (ACGuiScreen.wrapped$isCtrlKeyDown()) {
    ...
    public void lIIlIlIllIIlIIIlIIIlllIII() {
        if (this.IllIllIIIlIIlllIIIllIllII()) {
            if (this.IIIlIIllllIIllllllIlIIIll()) {
                Ref.modified$drawRect(this.x, this.y, this.x + this.width, this.y + this.height, this.IlIIlIIIIlIIIIllllIIlIllI);
            }
