...
public class FriendRequestElement extends AbstractElement {
    ...
    public void handleElementDraw(float mouseX, float mouseY, boolean enableMouse) {
        ...
        ResourceLocation location = ArchClient.getInstance().getHeadLocation(EnumChatFormattingBridge.getTextWithoutFormattingCodes(this.friendRequest.getUsername()));
