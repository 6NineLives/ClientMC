...
public class WorldTimeElement extends AbstractModulesGuiElement {
    ...
    private ResourceLocation sunIcon = Ref.getInstanceCreator().createResourceLocation("client/icons/sun-64.png");
    private ResourceLocation moonIcon = Ref.getInstanceCreator().createResourceLocation("client/icons/moon-64.png");

    public WorldTimeElement(Setting aCSetting, float f) {
        super(f);
        this.setting = aCSetting;
        this.height = 22;
        this.time = Float.parseFloat(aCSetting.value().toString());
    }
    ...
    public void handleDrawElement(int mouseX, int mouseY, float partialTicks) {
        ...
        int foregroundColor = ArchClient.getInstance().getGlobalSettings().isDarkMode() ? -1 : -1895825408;
        int overlayColor = ArchClient.getInstance().getGlobalSettings().isDarkMode() ? 0x6FFFFFFF : 0x6F000000;
        ...
        RenderUtil.drawRoundedRect((double)(this.x + 174), (double)(this.y + 16), (double)(this.x + 170 + n3 - 4), (double)(this.y + 18), 1.0, bl ?
                (ArchClient.getInstance().getGlobalSettings().isDarkMode() ? 0x8FFFFFFF : 0x8F000000) : overlayColor);
        double d = n3 - 18;
        ...
        if (this.IlllIllIlIIIIlIIlIIllIIIl) {
            ...
            Ref.getMinecraft().theWorld.setWorldTime((long) ArchClient.getInstance().globalSettings.worldTime.<Integer>value());
        ...
        float f6 = ((f5 - f4) / 20f + f3 * 8f) / (float)(Minecraft.getDebugFPS() + 1);
