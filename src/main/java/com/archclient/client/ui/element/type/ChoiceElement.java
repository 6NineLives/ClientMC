...
public class ChoiceElement
    ...
    private final ResourceLocation leftIcon = Ref.getInstanceCreator().createResourceLocation("client/icons/left.png");
    private final ResourceLocation rightIcon = Ref.getInstanceCreator().createResourceLocation("client/icons/right.png");
    ...
    public ChoiceElement(Setting aCSetting, float f) {
        super(f);
    ...
    public void handleDrawElement(int mouseX, int mouseY, float partialTicks) {
        ...
        FontRegistry.getUbuntuMedium16px().drawString(this.setting.getLabel().toUpperCase(), this.x + 10f, this.y + 4f, ArchClient.getInstance().globalSettings.isDarkMode() ? -1 : (leftHovered || rightHovered ? -1090519040 : -1895825408));
        ...
        if (!bl3) {
            if (this.IlllIllIlIIIIlIIlIIllIIIl == 0) {
                FontRegistry.getUbuntuMedium16px().drawCenteredString(value, this.x + this.width - 48, this.y + 4, ArchClient.getInstance().globalSettings.isDarkMode() ? -1 : -1895825408);
            } else {
                boolean bl4 = this.IlllIllIlIIIIlIIlIIllIIIl == 1;
                FontRegistry.getUbuntuMedium16px().drawCenteredString(value, (float)(this.x + this.width - 48) - (bl4 ? -this.IlIlllIIIIllIllllIllIIlIl : this.IlIlllIIIIllIllllIllIIlIl), this.y + 4, ArchClient.getInstance().globalSettings.isDarkMode() ? -1 : -1895825408);
                if (bl4) {
                    FontRegistry.getUbuntuMedium16px().drawCenteredString(value, (float)(this.x + this.width - 98) + this.IlIlllIIIIllIllllIllIIlIl, this.y + 4, ArchClient.getInstance().globalSettings.isDarkMode() ? -1 : -1895825408);
                } else {
                    FontRegistry.getUbuntuMedium16px().drawCenteredString(value, (float)(this.x + this.width + 2) - this.IlIlllIIIIllIllllIllIIlIl, this.y + 4, ArchClient.getInstance().globalSettings.isDarkMode() ? -1 : -1895825408);
                }
                ...
                int thisRectColor = ArchClient.getInstance().globalSettings.isDarkMode() ? -13619151 : -723724;
            ...
            if (this.IlIlllIIIIllIllllIllIIlIl >= (float)50) {
                ...
                float f5 = ACModulesGui.getSmoothFloat((float)50 + this.IlIlllIIIIllIllllIllIIlIl * (float)15);
        ...
        boolean dark = ArchClient.getInstance().getGlobalSettings().isDarkMode();
    ...
    public void handleMouseClick(int mouseX, int mouseY, int button) {
        ...
        if ((leftHovered || rightHovered) && this.IlllIllIlIIIIlIIlIIllIIIl == 0) {
            ...
            if (this.setting == ArchClient.getInstance().globalSettings.clearGlass) {
