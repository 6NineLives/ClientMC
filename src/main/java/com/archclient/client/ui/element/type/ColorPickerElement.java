...
public class ColorPickerElement extends AbstractModulesGuiElement {
    ...
    public ColorPickerElement(Setting setting, float f) {
        ...
        for (int i = 0; i < 16; ++i) {
            int n = Ref.getMinecraft().fontRendererObj.getColorForID(i);
    ...
    public void handleDrawElement(int mouseX, int mouseY, float partialTicks) {
        ...
        FontRegistry.getUbuntuMedium16px().drawString(this.setting.getLabel().toUpperCase(), this.x + 10, (float)(this.y + 4), ArchClient.getInstance().globalSettings.isDarkMode() ? -1 : -1895825408);
        ...
        FontRegistry.getPlayBold18px().drawString("#", this.x + 188, (float)(this.y + 4),
                ArchClient.getInstance().getGlobalSettings().isDarkMode() ? 0xAFFFFFFF : 0xAF000000);
        ...
        string = bl ? "(Favorite)" : "(+)";
        if (ArchClient.getInstance().globalSettings.isFavouriteColor(this.setting.<Integer>value())) {
        ...
        FontRegistry.getPlayBold18px().drawString(string, this.x + this.width - 16 - FontRegistry.getPlayBold18px().getStringWidth(string), (float)(this.y + 4),
                ArchClient.getInstance().getGlobalSettings().isDarkMode() ? (bl ? 0xCFFFFFFF : 0xAFFFFFFF) : (bl ? 0xCF000000 : 0xAF000000));
        if (this.lIIIIllIIlIlIllIIIlIllIlI) {
            ...
            worldrenderer.pos(this.pickerX, IIIIIIlIlIlIllllllIlllIlI, 0.0).endVertex();
            worldrenderer.pos(lIIIIIllllIIIIlIlIIIIlIlI, IIIIIIlIlIlIllllllIlllIlI, 0.0).endVertex();
            worldrenderer.pos(lIIIIIllllIIIIlIlIIIIlIlI, this.pickerY, 0.0).endVertex();
            worldrenderer.pos(this.pickerX, this.pickerY, 0.0).endVertex();
            tessellator.draw();
            int[] arrn = null;
            int n3 = 0;
            while ((float)n3 < this.pickerWidth) {
                ...
                while ((float)n4 < this.pickerHeight) {
                    ...
                    int n5 = (int)this.llIlIIIlIIIIlIlllIlIIIIll << 24 | MathHelper.HSBtoRGB(this.IIIlllIIIllIllIlIIIIIIlII, f2, f3);
            ...
            FontRegistry.getPlayRegular16px().drawString("CHROMA", this.pickerX - (float)40, this.pickerY, ArchClient.getInstance().getGlobalSettings().isDarkMode() ? -1 : -1358954496);
            ...
            this.drawColorList(ArchClient.getInstance().globalSettings.IlIIlIIlIllIIIIllIIllIlIl, this.lIIlIIllIIIIIlIllIIIIllII, this.lIIlllIIlIlllllllllIIIIIl, mouseX, mouseY, (int) partialTicks);
            this.lIllIllIlIIllIllIlIlIIlIl = (int)(this.pickerX + this.pickerWidth + (float)94);
            this.llIlIIIllIIIIlllIlIIIIIlI = (int)this.pickerY;
            this.drawColorList(ArchClient.getInstance().globalSettings.favouriteColors, this.lIllIllIlIIllIllIlIlIIlIl, this.llIlIIIllIIIIlllIlIIIIIlI, mouseX, mouseY, (int) partialTicks);
    ...
    private void lIIIIIIIIIlIllIIllIlIIlIl() {
        if (ArchClient.getInstance().globalSettings.IlIIlIIlIllIIIIllIIllIlIl.size() >= 16) {
            ArchClient.getInstance().globalSettings.IlIIlIIlIllIIIIllIIllIlIl.remove(0);
        }
        ArchClient.getInstance().globalSettings.IlIIlIIlIllIIIIllIIllIlIl.add(new ColorPickerColorElement(this.scale, this.setting.<Integer>value()));
    ...
    private void lIIIIIIIIIlIllIIllIlIIlIl(int n2) {
        ...
        while ((float)n3 < this.pickerHeight) {
            ...
            int n5 = (((Math.round((float)255 - (float)n3 / this.pickerHeight * (float)255)) & 0xFF) << 24) |
                    (((n4 >> 16 & 0xFF) & 0xFF) << 16) |
                    (((n4 >> 8 & 0xFF) & 0xFF) << 8)  |
                    (((n4 & 0xFF) & 0xFF) << 0);
    ...
    private void IlllIIIlIlllIllIlIIlllIlI(int n2) {
        ...
        while ((float)n3 < this.pickerHeight) {
            ...
            if (this.IlIlllIIIIllIllllIllIIlIl && (float)n2 >= ((float)this.yOffset + this.pickerY + (float)n3) * this.scale && (float)n2 <= ((float)this.yOffset + this.pickerY + (float)n3 + 1.0f) * this.scale) {
                ...
                float[] arrf = MathHelper.RGBtoHSB(n4 >> 16 & 0xFF, n4 >> 8 & 0xFF, n4 & 0xFF, null);
                this.setting.setValue(MathHelper.HSBtoRGB(this.IIIlllIIIllIllIlIIIIIIlII, arrf[1], arrf[2]));
                this.IIIlllIIIllIllIlIIIIIIlII = (float)n3 / this.pickerHeight;
            }
            n4 = MathHelper.HSBtoRGB((float)n3 / this.pickerHeight, 1.0f, 1.0f);
    ...
    private void lIIIIlIIllIIlIIlIIIlIIllI(List<ColorPickerColorElement> list, int n, int n2, int n3, int n4) {
        ...
        for (ColorPickerColorElement colorPickerColorElement : list) {
            ...
            if (colorPickerColorElement.isMouseInside(n3, n4)) {
                if (list == this.colors) {
                    this.setting.setValue(0xff000000 | colorPickerColorElement.color);
                } else {
                    this.setting.setValue(colorPickerColorElement.color);
                }
                Ref.getMinecraft().getSoundHandler().playSound(Ref.getInstanceCreator().createSoundFromPSR(Ref.getInstanceCreator().createResourceLocation("gui.button.press"), 1.0f));
                float[] arrf = MathHelper.RGBtoHSB(colorPickerColorElement.color >> 16 & 0xFF, colorPickerColorElement.color >> 8 & 0xFF, colorPickerColorElement.color & 0xFF, null);
    ...
    public void handleMouseClick(int mouseX, int mouseY, int button) {
        ...
        if (bl) {
            Ref.getMinecraft().getSoundHandler().playSound(Ref.getInstanceCreator().createSoundFromPSR(Ref.getInstanceCreator().createResourceLocation("gui.button.press"), 1.0f));
            float[] arrf = MathHelper.RGBtoHSB(this.setting.<Integer>value() >> 16 & 0xFF, this.setting.<Integer>value() >> 8 & 0xFF, this.setting.<Integer>value() & 0xFF, null);
            this.IIIlllIIIllIllIlIIIIIIlII = arrf[0];
            ...
            if (ArchClient.getInstance().globalSettings.isFavouriteColor(this.setting.<Integer>value())) {
                ArchClient.getInstance().globalSettings.removeFavouriteColor(this.setting.<Integer>value());
            } else {
                if (ArchClient.getInstance().globalSettings.favouriteColors.size() >= 16) {
                    ArchClient.getInstance().globalSettings.favouriteColors.remove(0);
                }
                ArchClient.getInstance().globalSettings.favouriteColors.add(new ColorPickerColorElement(this.scale, this.setting.<Integer>value()));
            }
            Ref.getMinecraft().getSoundHandler().playSound(Ref.getInstanceCreator().createSoundFromPSR(Ref.getInstanceCreator().createResourceLocation("gui.button.press"), 1.0f));
        } else if (this.lIIIIllIIlIlIllIIIlIllIlI) {
            boolean bl4;
            this.lIIIIlIIllIIlIIlIIIlIIllI(this.colors, 0, 0, mouseX, mouseY);
            this.lIIIIlIIllIIlIIlIIIlIIllI(ArchClient.getInstance().globalSettings.IlIIlIIlIllIIIIllIIllIlIl, this.lIIlIIllIIIIIlIllIIIIllII, this.lIIlllIIlIlllllllllIIIIIl, mouseX, mouseY);
            this.lIIIIlIIllIIlIIlIIIlIIllI(ArchClient.getInstance().globalSettings.favouriteColors, this.lIllIllIlIIllIllIlIlIIlIl, this.llIlIIIllIIIIlllIlIIIIIlI, mouseX, mouseY);
