...
public class FriendsManager {
    ...
    public void addUnreadMessage(String playerId, String message) {
        ...
        String prefix = EnumChatFormattingBridge.GRAY + LocalDateTime.now().format(this.timeFormatter);
        String suffix = EnumChatFormattingBridge.GREEN + friend.getName() + EnumChatFormattingBridge.RESET;
    ...
    public void addOutgoingMessage(String playerId, String message) {
        ...
        String prefix = EnumChatFormattingBridge.GRAY + LocalDateTime.now().format(this.timeFormatter);
        String suffix = EnumChatFormattingBridge.AQUA + Ref.getMinecraft().getSession().getProfile().getName() + EnumChatFormattingBridge.RESET;
        String concat = prefix + " " + suffix + ": " + message;
