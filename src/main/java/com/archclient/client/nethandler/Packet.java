...
public abstract class Packet {
    ...
    public abstract void process(IACNetHandler handler);

    public static Packet handle(IACNetHandler netHandler, byte[] data) {
        return Packet.handle(netHandler, data, null);
    }

    public static Packet handle(IACNetHandler netHandler, byte[] data, Object attachment) {
        ByteBufWrapper wrappedBuffer = new ByteBufWrapper(Unpooled.buffer(data, data.length));
