package com.archclient.impl.extra;
...
public class ACMovementInputHelperImpl extends MovementInputFromOptions implements ACMovementInputHelper {
    ...
    public ACMovementInputHelperImpl(GameSettings gameSettings) {
        super(gameSettings);
    }
    ...
    public static void lIIIIlIIllIIlIIlIIIlIIllI(Minecraft minecraft, MovementInputFromOptions movementInputFromOptions, EntityPlayerSP entityPlayerSP) {
        ...
        if (ToggleSprintModule.toggleSneak.<Boolean>value() && ArchClient.getInstance().getModuleManager()
        ...
        ACMovementInputHelperImpl.lIIIIlIIllIIlIIlIIIlIIllI(movementInputFromOptions, entityPlayerSP, gameSettings);
    }
    ...
    private static void lIIIIlIIllIIlIIlIIIlIIllI(MovementInputFromOptions movementInputFromOptions, EntityPlayerSP entityPlayerSP, GameSettings gameSettings) {
        ...
        ToggleSprintModule module = ArchClient.getInstance().getModuleManager().toggleSprint;
