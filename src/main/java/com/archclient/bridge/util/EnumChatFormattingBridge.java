package com.archclient.bridge.util;
...
public enum EnumChatFormattingBridge {
    ...
    /**
     * Matches formatting codes that indicate that the com.archclient.client should treat the following text as bold, recolored,
     * obfuscated, etc.
     */
    ...
    /**
     * The control string (section sign + formatting code) that can be inserted into com.archclient.client-side text to display
